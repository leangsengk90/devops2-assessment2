...
module "api_gateway_log_group" {
  ...
  log_group_name    = "/aws/apigateway/devops2-g4-auth-${terraform.workspace}"
  retention_in_days = 7
...
module "ecs_cluster" {
  ...
  cluster_name              = "devops2-g4-auth-cluster"
  environment               = terraform.workspace
  service_name              = "devops2-g4-auth"
...
module "api_gateway" {
  ...
  api_name            = "devops2-g4-auth"
  api_description     = "API Gateway for auth service"
  environment         = terraform.workspace
  service_name        = "devops2-g4-auth"
